...
vector<int> topview(Node *root)
{
    ...
    if (root == NULL)
        return ans;
    map<int, int> topNode;      // horizontal number map with data only top node
    ...
    while (!q.empty())
    {
        ...
        // check horizontal number present or not
        if (!topNode[num])
        {
            topNode[num] = frontNode->data;
        }
        // left child push
...
int main(int argc, char const *argv[])
{
    ...
    cout << endl;
    cout << "Top View of Binary Tree 1 : ";
    ...
    cout << "Top View of Binary Tree 2 : ";
    ans = topview(root1);
    print(ans);
    ...
    cout << "Top View of Binary Tree 3 : ";
    ans = topview(root2);
    print(ans);
